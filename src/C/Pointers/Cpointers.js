...
import cpquestions from './cpquestions.json'
...
import classNames from 'classnames/bind';
 ...
 class Cpointers extends Component {
     constructor(props){
         super(props);
         this.state = {
            cpquestions,
     ...
     componentDidMount () {
         ...
         this.displayQuestions(cpquestions ,currentQuestion , nextQuestion , previousQuestion);
         this.startTimer();
     }
     ...
     displayQuestions =(
         cpquestions = this.state.cpquestions ,  
         currentQuestion, nextQuestion , previousQuestion
        ) => {
            let{ currentQuestionIndex} = this.state;
            if(!isEmpty(this.state.cpquestions)){
                cpquestions = this.state.cpquestions;
                currentQuestion = cpquestions[currentQuestionIndex];
                nextQuestion = cpquestions[currentQuestionIndex + 1];
                previousQuestion = cpquestions[ currentQuestionIndex - 1];
                const answer = currentQuestion.answer;
                this.setState({
                        currentQuestion , 
                        nextQuestion,
                        previousQuestion,
                        numberofQuestions:cpquestions.length,
                        answer,
                        previousRandomNumbers: []
                } , () => {
                    this.showOptions();
        ...
        correctAnswers = () => {
            ...
            this.setState(prevState => ({
                ...
                if(this.state.nextQuestion === undefined){
                    ...
                    this.displayQuestions(this.state.cpquestions , this.state.currentQuestion , this.state.nextQuestion , this.state.previousQuestion);
                }
        ...
        handleHints = () => {
           ...
           endGame = () => {
               ...
               setTimeout(() => {
                  this.props.history.push('/Cpsummary' , playStats) 
               }, 1000);
           }
