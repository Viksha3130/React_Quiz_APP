      ...
      <Fragment>
          ...
          <div className="instructions container">
              ...
              <ul className="browser-default" id="main-list">
                  ...
                  <div>
                      <span className="left"><Link to="/Ccourse">No,take me back</Link></span>
                      <span className="right"><Link to="/Cfunction">Okay, Let's do this!</Link></span>
                  </div>
...
export default Cfunctioninstruction;