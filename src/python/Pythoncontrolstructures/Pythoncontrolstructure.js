...
import csquestions from './csquestions.json'
...
import classNames from 'classnames/bind';
 ...
 class Pythoncontrolstructure extends Component {
     constructor(props){
         super(props);
         this.state = {
            csquestions,
     ...
     componentDidMount () {
         const {csquestions , currentQuestion , nextQuestion , previousQuestion } = this.state;
         this.displayQuestions(csquestions ,currentQuestion , nextQuestion , previousQuestion);
         this.startTimer();
     }
     ...
     displayQuestions =(
         csquestions = this.state.csquestions ,  
         currentQuestion, nextQuestion , previousQuestion
        ) => {
            let{ currentQuestionIndex} = this.state;
            if(!isEmpty(this.state.csquestions)){
                csquestions = this.state.csquestions;
                currentQuestion = csquestions[currentQuestionIndex];
                nextQuestion = csquestions[currentQuestionIndex + 1];
                previousQuestion = csquestions[ currentQuestionIndex - 1];
        ...
        correctAnswers = () => {
            ...
            this.setState(prevState => ({
                ...
                if(this.state.nextQuestion === undefined){
                    ...
                    this.displayQuestions(this.state.csquestions , this.state.currentQuestion , this.state.nextQuestion , this.state.previousQuestion);
                }
        ...
        handleHints = () => {
           ...
           endGame = () => {
               ...
               setTimeout(() => {
                  this.props.history.push('/Pythoncssummary' , playStats) 
               }, 1000);
           }
