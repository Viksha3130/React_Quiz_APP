...
import summary from '../../components/summary.css'

 class Pythoncssummary extends Component {
     constructor(props){
         super(props);
         this.state = {
             score: 0,
    ...
    render() {
        ...
        if(state !== undefined){
            stats=(<Fragment>
                ...
                <Link to  ="/Pythoncourse">Back to Home</Link>
                </button>
                          <button className="quizbtn"> 
                          <Link to ="/Pythoncontrolstructure" >Take a  Quiz</Link>
                          </button>
...
export default Pythoncssummary
