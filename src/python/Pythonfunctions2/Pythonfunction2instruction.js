...
import hints from '../../assets/images/hints.png'
 ...
 const Pythonfunction2instruction = () => {
    return (
      <Fragment>
          <Helmet>
          ...
          <div className="instructions container">
              ...
              <ul className="browser-default" id="main-list">
                  ...
                  <div>
                      <span className="left"><Link to="/Pythoncourse">No,take me back</Link></span>
                      <span className="right"><Link to="/Pythonfunction2">Okay, Let's do this!</Link></span>
                  </div>
...
export default Pythonfunction2instruction;